<%@ Page Title="" Language="C#" MasterPageFile="~/Common/Main.master" AutoEventWireup="true" CodeFile="Search.aspx.cs" Inherits="Search" %>
...
<div style="direction:rtl; text-decoration:none;">
    <asp:GridView ID="gvSearchResult" runat="server" EnableModelValidation="True" 
        ...
        CellPadding="4">
        <Columns>
            <asp:HyperLinkField HeaderText="تېما" DataNavigateUrlFields="ID" Target="_blank"
                DataTextField="Title" DataNavigateUrlFormatString="Articleinfo.aspx?id={0}" >
            <ItemStyle Width="60%" />
            </asp:HyperLinkField>
