...
public class FileHelper
{
    ...
    public string generateFileName(string extention)
    {
        string Folder = DateTime.Now.Year.ToString() + "/" + DateTime.Now.Month.ToString() + "/" + DateTime.Now.Day.ToString();
        string FullFolderPath = HttpContext.Current.Server.MapPath(System.Configuration.ConfigurationManager.AppSettings["FileFolder"]) + Folder;
        if (!Directory.Exists(FullFolderPath))
        {
            Directory.CreateDirectory(FullFolderPath);
        }
        return Folder+"/" +Guid.NewGuid().ToString("N")+extention;
    }
